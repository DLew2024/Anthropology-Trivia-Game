...
{
  // 2
  question: "Which of the following is a subfield of anthropology that focuses on the study of past human societies through excavation and analysis of artifacts?",
...
function draw() {
  ...
  switch(game.state) {
    ...
    case GameState.Playing:
      ...
      //Hourglass
      image(backgroundImg, 170, 65, 100, 105);
